...
class EncoderDecisionsDeviceTest {
    ...
    companion object {
        ...
        private val VARIANTS = mapOf(
            ...
            "ml_s512_fp32" to V(mapOf("main" to "laya_ml_s512_fp32.tflite", "act" to "laya_ml_act_head_fp32.tflite", "tokenizer" to "multilingual/tokenizer/tokenizer.json", "tokenizer_config" to "multilingual/tokenizer/tokenizer_config.json", "config" to "laya_ml_calibration.json"), "ml_rows_s512.json.gz", "ml_fixtures.json.gz", "ML_A01", "ml512"),
        )
