...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("io.github.john-rocky.hfmodels", "hfmodels-litertlm", project.findProperty("hfmodelsVersion") as String? ?: "0.1.2")
    pom {
...
// The E1 harness resolves the SDK from a local directory: ./gradlew publishAllPublicationsToLocalRepository -PhfmodelsVersion=0.1.2-local
publishing {
